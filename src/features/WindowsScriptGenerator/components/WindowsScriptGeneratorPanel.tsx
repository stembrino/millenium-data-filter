  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      <header className="mb-8 max-w-3xl">
        <p className="mb-2 text-xs font-bold uppercase tracking-[0.18em] text-[#4563e8]">
          Windows automation
        </p>
        ...
        <p className="mt-3 text-sm leading-6 text-slate-600">
          Prepare the copy criteria now. The generated Windows script will be
          expanded as the business rules are defined.
        </p>
      </header>
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Informe os nomes dos arquivos XML que devem ser copiados.
            </p>
          </div>
        ...
        <section className="rounded-xl border border-slate-200 bg-slate-950 p-6 shadow-sm">
          <div className="mb-5 flex items-center justify-between gap-4">
            <div>
              <h2 className="text-lg font-semibold text-white">Script draft</h2>
